...
// Part 1 Proter Alogrithm for doing stemming
...
//                System.out.println(str);
    ...
    public static void Part_1() {
        System.out.println("Hello world I am here bro");
        File file = null;
        ...
        try {
            ...
            Scanner sc = new Scanner(fis);    //file to be scanner
...
//                System.out.println(sc.nextLine());      //returns the line that was
                ...
                {
                    String word = P.stripAffixes(sc.nextLine().split(" ")[i]);
                    System.out.println(word);
                    filewriter.write(word);
                }
                String word = P.stripAffixes(sc.nextLine());
                filewriter.write(word);
...
//    Main function where you are doing stemming
...
//
        Phase2Part1 P = new Phase2Part1();
        P.Part_1();
//        String stemming_word = P.stripAffixes("going");
